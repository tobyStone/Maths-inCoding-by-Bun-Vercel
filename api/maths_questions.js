...
async function generateQuestions(description) {
    const prompt = `Generate a list of seven questions a student of the age of the numbers in the following decsription could ask about the topic based on the following video description: "${description}"`;
